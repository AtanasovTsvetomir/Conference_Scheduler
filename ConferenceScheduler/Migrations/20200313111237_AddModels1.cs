    ...
    public partial class AddModels1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpeakersConferences", x => new { x.SpeakerId, x.ConferenceId });
                    table.ForeignKey(
                        name: "FK_SpeakersConferences_Conferences_ConferenceId",
                        column: x => x.ConferenceId,
                        principalTable: "Conferences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SpeakersConferences_Speakers_SpeakerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersConferences", x => new { x.ConferenceId, x.ApplicationUserId });
                    table.ForeignKey(
                        name: "FK_UsersConferences_ApplicationUser_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpeakersConferences_ConferenceId",
                table: "SpeakersConferences",
                column: "ConferenceId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersConferences_ApplicationUserId",
